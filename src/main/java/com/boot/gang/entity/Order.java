...
public class Order {
    ...
    private Integer cState;         //  订单状态  0:待提交 1:待审核 2: 初审  3:审核通过   4:订单完结    5=库存不足(拼团时使用)
    ...
    public String toString() {
        return "Order{" +
                ...
                ", cRealname='" + cRealname + '\'' +
                ", cCouponId='" + cCouponId + '\'' +
                ", cCouponPrice=" + cCouponPrice +
                ", cCategory=" + cCategory +
                ", cCouponComment='" + cCouponComment + '\'' +
                ", cGroupNum='" + cGroupNum + '\'' +
                ", cMoneyPay=" + cMoneyPay +
                ", cPayTime=" + cPayTime +
                ", cPlanPayTime=" + cPlanPayTime +
                ", cPlatformComment='" + cPlatformComment + '\'' +
                ", cPlatformPrice=" + cPlatformPrice +
                ", cTransportPrice=" + cTransportPrice +
                ", cTransportationRequirement='" + cTransportationRequirement + '\'' +
                ", cWhiteNoteComment='" + cWhiteNoteComment + '\'' +
                ", cWhiteNotePrice=" + cWhiteNotePrice +
                ", cNum=" + cNum +
                ", cGold=" + cGold +
                ...
                ", cFahuoTime=" + cFahuoTime +
                ", cGoodsInterval='" + cGoodsInterval + '\'' +
                ", cGoodsSex=" + cGoodsSex +
                ", cGoodsTotal=" + cGoodsTotal +
                ", cGuige='" + cGuige + '\'' +
                ", cGzFl=" + cGzFl +
                ", cIfCanInvoice=" + cIfCanInvoice +
                ", cIfReply=" + cIfReply +
                ", cIfTake=" + cIfTake +
                ", cIfxianshang=" + cIfxianshang +
                ", cInvoiceTitle='" + cInvoiceTitle + '\'' +
                ", cLeixing='" + cLeixing + '\'' +
                ", cLogisticsId='" + cLogisticsId + '\'' +
                ", cOrderSsid=" + cOrderSsid +
                ", cOutTradeNo='" + cOutTradeNo + '\'' +
                ", cPayType='" + cPayType + '\'' +
                ", cPayUser='" + cPayUser + '\'' +
                ", cProductCode='" + cProductCode + '\'' +
                ", cProductId='" + cProductId + '\'' +
                ", cProductLogo='" + cProductLogo + '\'' +
                ", cProductName='" + cProductName + '\'' +
                ", cRequire='" + cRequire + '\'' +
                ", cSexPrice=" + cSexPrice +
                ", cShopbId='" + cShopbId + '\'' +
                ", cShopId='" + cShopId + '\'' +
                ", cShouhuoTime=" + cShouhuoTime +
                ", cSummary='" + cSummary + '\'' +
                ", cTihuoShopId='" + cTihuoShopId + '\'' +
                ", cTrackingComp='" + cTrackingComp + '\'' +
                ", cTrackingNo='" + cTrackingNo + '\'' +
                ", cTransactionId='" + cTransactionId + '\'' +
                ", cType=" + cType +
                ", cUnitPrice=" + cUnitPrice +
                ", cYoufeiFee=" + cYoufeiFee +
                ", cZhPrice=" + cZhPrice +
                ", cZjrFl=" + cZjrFl +
                ", cFactId='" + cFactId + '\'' +
                ", cFactName='" + cFactName + '\'' +
                ", cShopName='" + cShopName + '\'' +
                ", cHide='" + cHide + '\'' +
                ", cFactMoney=" + cFactMoney +
                ", cPlatMoney=" + cPlatMoney +
                ", cShopMoney=" + cShopMoney +
                ", cRefundNum=" + cRefundNum +
                ", cDispute=" + cDispute +
                ", cStage=" + cStage +
                ", cAgentId='" + cAgentId + '\'' +
                ", cAgentMoney=" + cAgentMoney +
                ", cAgentName='" + cAgentName + '\'' +
                ", cProduct2Id='" + cProduct2Id + '\'' +
                ", cOneGold=" + cOneGold +
                ", cThreeGold=" + cThreeGold +
                ", cTwoGold=" + cTwoGold +
                ", cTihuoShopCode='" + cTihuoShopCode + '\'' +
                ", cTihuoShopName='" + cTihuoShopName + '\'' +
                ", cFuwuFee=" + cFuwuFee +
                ", cIfZiti='" + cIfZiti + '\'' +
                ", cSctype=" + cSctype +
                ", cFuwuFeeType='" + cFuwuFeeType + '\'' +
                ", cUserNo='" + cUserNo + '\'' +
                ", cIfPingjia=" + cIfPingjia +
                ", cMemberId='" + cMemberId + '\'' +
                ", cMemberName='" + cMemberName + '\'' +
                ", cMemberNo=" + cMemberNo +
                ", cMemberTime='" + cMemberTime + '\'' +
                ", cPingjiaMemo='" + cPingjiaMemo + '\'' +
                ", cPingjiaStar=" + cPingjiaStar +
                ", cXsnum='" + cXsnum + '\'' +
                ", cZkbl='" + cZkbl + '\'' +
                ", cMtlGold=" + cMtlGold +
                '}';
